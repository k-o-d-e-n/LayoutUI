...
let package = Package(
    ...
    products: [
        .executable(name: "LayoutUI-Example", targets: ["LayoutUI-Example"]),
        .library(name: "LayoutUI", targets: ["LayoutUI"])
    ],
    dependencies: [],
    targets: [
        .executableTarget(name: "LayoutUI-Example", dependencies: ["LayoutUI"]),
